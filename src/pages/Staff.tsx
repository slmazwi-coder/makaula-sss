...
const StaffCard = ({ member }: { member: typeof staffData[number] }) => (
  <div
    ...
    style={{ background: '#F8FAFF', border: '1px solid #DAA520' }}
  >
    <div
      className="w-24 h-24 rounded-full flex items-center justify-center mb-4 overflow-hidden"
      style={{ background: '#EEF1F8', border: '3px solid #DAA520' }}
    >
      {member.image ? (
        <img
          src={member.image}
    ...
    <h3 className="text-sm font-bold leading-tight" style={{ color: '#0D1B4C' }}>
      {member.name}
    </h3>
    ...
    {member.subject && (
      <span
        ...
        style={{ background: '#EEF1F8', color: '#0D1B4C', border: '1px solid #DAA520' }}
      >
        {member.subject}
      </span>
    )}
...
export const Staff = () => {
  ...
  return (
    <div className="min-h-screen py-12 px-4" style={{ background: '#EEF1F8' }}>
      <div className="max-w-7xl mx-auto">

        <div className="text-center mb-10">
          <h1 className="text-4xl font-extrabold tracking-tight mb-3" style={{ color: '#0D1B4C' }}>
            Our Staff
          </h1>
          <div className="w-16 h-1 mx-auto rounded-full mb-4" style={{ background: '#DAA520' }} />
          <p className="text-gray-500 text-base max-w-2xl mx-auto">
            Meet the dedicated team of educators and support staff at Makaula Senior Secondary School.
          </p>
        </div>
            ...
            <button
              ...
              style={
                activeCategory === cat
                  ...
                  : { background: '#fff', color: '#0D1B4C', border: '1px solid rgba(218,165,32,0.4)' }
              }
            >
              {cat}
            </button>
