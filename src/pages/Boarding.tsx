...
const DECL_CACHE_KEY = 'mk_boarding_decl_deadline';
const BOARDING_FORM_CACHE_KEY = 'mk_boarding_form_cache';
...
export const Boarding = () => {
  ...
  const [learner, setL] = useState({
    surnameAndName: '',
    homeAddress: '',
    schoolNameAndAddress: 'Makaula SSS, Makaula, Eastern Cape',
    currentGrade: '',
    gender: '',
