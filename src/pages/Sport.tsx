    ...
    <div className="py-12 sm:py-16 bg-white min-h-screen">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <p className="text-center text-lg text-gray-600 mb-12 max-w-3xl mx-auto">
          Makaula SSS offers structured sport programs to develop teamwork, fitness, and discipline.
        </p>
            ...
            {sports.map((s) => (
              <div key={s.name} className="bg-gray-50 rounded-3xl border border-gray-100 p-7">
                <div className="flex items-center gap-3 mb-3">
                  <div className="p-3 rounded-2xl bg-white border border-gray-200 text-[#0D1B4C]">
                    <s.icon size={22} />
                  </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
          <section className="bg-gray-50 rounded-3xl border border-gray-100 p-7">
            ...
            <div className="mt-5 text-xs text-gray-500 flex items-center gap-2">
              <Flag size={16} /> Fixtures will be updated as scheduled.
            </div>
          </section>
          ...
          <section className="bg-gray-50 rounded-3xl border border-gray-100 p-7">
                ...
                <tbody className="text-gray-800">
                  {results.map((r, i) => (
                    <tr key={i} className="border-t border-gray-200">
                      ...
                      <td className="py-3 whitespace-nowrap font-bold">{r.result}</td>
                    </tr>
                  ))}
                </tbody>
              </table>
            ...
            <div className="mt-5 text-xs text-gray-500 flex items-center gap-2">
              <Flag size={16} /> Results will be updated after each event.
            </div>
          </section>
        </div>
      </div>
