            ...
            filteredDocs.map((doc) => (
              ...
              >
                <div className="flex items-start gap-4">
                  <div className="p-3 bg-[#EEF1F8] text-[#0D1B4C] rounded-xl group-hover:bg-[#B8860B] group-hover:text-white transition-colors">
                    <FileText size={24} />
                  </div>
                  <div className="flex-grow">
                    ...
                    <button
                      ...
                      className="flex items-center gap-2 text-[#0D1B4C] font-bold hover:underline"
                    >
