      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 lg:gap-16">
          <motion.div initial={{ opacity: 0, y: 24 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.3 }}>
            <h2 className="text-2xl font-bold text-[#0D1B4C] mb-8">Get in Touch</h2>
            <div className="space-y-8">
              <div className="flex items-start gap-4">
                <div className="p-3 bg-[#EEF1F8] text-[#0D1B4C] rounded-xl">
                  <MapPin size={24} />
                </div>
                <div>
              ...
              <div className="flex items-start gap-4">
                ...
                <div>
                  ...
                  <p className="text-gray-600">{info.phone || 'Contact the school office'}</p>
                </div>
              </div>
              <div className="flex items-start gap-4">
                <div className="p-3 bg-[#EEF1F8] text-[#0D1B4C] rounded-xl">
                ...
                <div>
                  ...
                  <p className="text-gray-600 break-words">{info.email || 'Contact the school office'}</p>
                </div>
              </div>
              <div className="flex items-start gap-4">
                <div className="p-3 bg-[#EEF1F8] text-[#0D1B4C] rounded-xl">
          ...
          >
            <h2 className="text-2xl font-bold text-[#0D1B4C] mb-8">Send us a Message</h2>
